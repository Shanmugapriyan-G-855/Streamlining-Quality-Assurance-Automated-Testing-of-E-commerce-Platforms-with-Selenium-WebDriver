...
public class EcommerceWebsiteAutomation {
	...
	public static Boolean TestCase01(ChromeDriver driver) throws InterruptedException, IOException {
		Boolean status;
		...
		status = loginPage.PerformLogin("visual_user", "secret_sauce");

		TakesScreenshot ts = (TakesScreenshot) driver;
		File screenShotAs = ts.getScreenshotAs(OutputType.FILE);
		File f = new File("./Screenshot\\Login.png");
	...
	public static Boolean TestCase02(ChromeDriver driver) throws InterruptedException, IOException {
		Boolean status;
		...
		TakesScreenshot ts = (TakesScreenshot) driver;
		File screenShotAs = ts.getScreenshotAs(OutputType.FILE);
		File f = new File("./Screenshot\\Filter.png");
		FileUtils.copyFile(screenShotAs, f);
		if (!status) {
	...
	public static Boolean TestCase03(ChromeDriver driver) throws InterruptedException, IOException {
		Boolean status;
		...
		TakesScreenshot ts = (TakesScreenshot) driver;
		File screenShotAs = ts.getScreenshotAs(OutputType.FILE);
		File f = new File("./Screenshot\\LAddToCart.png");
		FileUtils.copyFile(screenShotAs, f);
		if (!status) {
	...
	public static Boolean TestCase04(ChromeDriver driver) throws InterruptedException, IOException {
		Boolean status;
		logStatus("Start TestCase", "Test Case 04: Checkout functionality", "DONE");
		CheckoutPage checkout = new CheckoutPage(driver);
		checkout.navigateToCartPage();
		status = checkout.PerformCheckoutFunctionality("Shanmugapriyan", "Gunasekaran", "637201");
		TakesScreenshot ts = (TakesScreenshot) driver;
		File screenShotAs = ts.getScreenshotAs(OutputType.FILE);
		File f = new File("./Screenshot\\Checkout.png");
		FileUtils.copyFile(screenShotAs, f);
		if (!status) {
	...
	public static Boolean TestCase05(ChromeDriver driver) throws InterruptedException, IOException {
		Boolean status;
		...
		TakesScreenshot ts = (TakesScreenshot) driver;
		File screenShotAs = ts.getScreenshotAs(OutputType.FILE);
		File f = new File("./Screenshot\\Logout.png");
		FileUtils.copyFile(screenShotAs, f);
		if (!status) {
